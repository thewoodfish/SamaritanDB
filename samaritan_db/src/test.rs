/// this module was a test module to demo the smart contract writing as a simulated JSON app
#[cfg(test)]
mod test {
    ...
    pub fn account_is_auth(did: &str, password: AuthContent, is_auth: bool) -> bool {
        let output = Command::new("curl")
            .args([
                ...
                "--data",
                &format!(
                    r##"{{"did": "{did}", "auth_content": "{password}", "is_auth": {is_auth}}}"##
                ),
    ...
    pub fn revoke_app_access(file_key: HashKey, app_did: &str, revoke: bool) -> bool {
        let output = Command::new("curl")
            .args([
                ...
                "--data",
                &format!(
                    r##"{{"file_key": "{file_key}", "app_did": "{app_did}", "revoke": {revoke}}}"##
                ),
